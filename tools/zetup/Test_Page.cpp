...
void __fastcall TForm4::Button1Click(TObject *Sender)
{
   ...
   if(CheckBox5->Checked) {
      ...
      Screen->Cursor=crArrow;
      if(!Fail) ShowMessage("SDRAM Test Passed!!");
      else      ShowMessage("SDRAM Test Failed!!");
   }
   //---------------------------------------------------
   // SRAM Test
   //---------------------------------------------------
   ...
   if(CheckBox4->Checked) {
      Screen->Cursor=crHourGlass;
      int Error=0;
      Form1->Button3Click(this);   //  Erase FLASH
      ...
      Form1->iFL_DATA->Text="00";
      Screen->Cursor=crArrow;
      if(Error<16) ShowMessage("FLASH Test Passed.");
      else         ShowMessage("FLASH Test Failed.");
   }
   //---------------------------------------------------
   // LCD Test
   //---------------------------------------------------
